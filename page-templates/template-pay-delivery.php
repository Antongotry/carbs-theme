      ...
      <div class="crabs-paydel__grid">
        ...
        <article class="crabs-card">
          ...
          <div class="crabs-card__block">
            <h3 class="crabs-card__h">Термін доставки</h3>
            <p class="crabs-card__p">
              Доставка замовлень займає <strong>1–2 дні</strong> з моменту відправлення (згідно тарифів перевізника на сторінці оформлення замовлення).
            </p>
          </div>

          <div class="crabs-card__block">
            <h3 class="crabs-card__h">Обробка замовлень</h3>
            <p class="crabs-card__p">
              Замовлення обробляються <strong>понеділок – п’ятниця з 9:00 до 18:00</strong>. Замовлення, оформлені після 18:00 або у вихідні, обробляються наступного робочого дня.
            </p>
          </div>
          ...
          <div class="crabs-card__block">
            ...
            <p class="crabs-card__p">
              ...
              <strong>При замовленні від 5000 грн</strong> доставка безкоштовна.<br>
              <strong>Для замовлень до 5000 грн</strong> вартість доставки розраховується за тарифами перевізника (відображається при оформленні замовлення).
            </p>
          </div>
