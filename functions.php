...
add_filter('woocommerce_gateway_title', function($title, $gateway_id){
    ...
    if (
        $gateway_id === 'monocheckout'
        || $gateway_id === 'wayforpay'
        || $plain_title === 'Оплата частинами'
        || $plain_title === 'Оплата частинами (Mono)'
        || $plain_title === 'Оплата частинами до 5 платежів'
    ) {
        return 'Оплата частинами (2-5 платежів під 0%)';
    }
