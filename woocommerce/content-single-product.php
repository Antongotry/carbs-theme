...
<!--			</div>-->
	...
	<?php
	$payment_content = '<h4>Оплата при отриманні</h4>'
		. '<p>Ви можете оплатити замовлення у відділенні Нової Пошти після огляду товару.</p>'
		. '<h4>Онлайн-оплата</h4>'
		. '<p>Оплатити замовлення можна онлайн через:</p>'
		. '<ul>'
		...
		. '</ul>'
		. '<p>Оплата проходить швидко та безпечно, без додаткових комісій.</p>'
		. '<h4>Оплата на рахунок ФОП</h4>'
		. '<p>За потреби ви можете оплатити замовлення за реквізитами. Усі дані ми надаємо після оформлення замовлення.</p>'
		. '<h4>Готівкою</h4>'
		. '<p>Готівковий розрахунок доступний при самовивезенні в Івано-Франківську.</p>';

	$shipping_content = '<h4>Нова Пошта</h4>'
		. '<p>Доставляємо замовлення по всій Україні службою Нова Пошта.</p>'
		. '<ul>'
		...
		. '</ul>'
		. '<h4>Самовивіз</h4>'
		. '<p>Якщо вам зручно забрати покупку особисто, ви можете скористатися самовивозом з нашого шоуруму: м. Івано-Франківськ, вул. Вовчинецька, 227.</p>'
		. '<h4>Термін обробки замовлень</h4>'
		. '<p>Заявки опрацьовуються у робочий час:<br>ПН-ПТ з 10:00 до 19:00<br>СБ з 11:00 до 18:00<br>Неділя - вихідний</p>';
	?>
